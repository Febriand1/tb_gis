                ...
                <div class="card">
                    <div class="card-body" style="overflow:auto">
                        <table style="width: 100%;">
                            <tr>
                                <td><label for="labelNama">ID Sekolah</label></td>
                                <td><input type="text" size="70" id="InputID" placeholder="ID Sekolah" name="sekolah_id"></td>
                            </tr>
                            <tr>
                    ...
                    <div class="card-border">
                        ...
                        <a href="{{route('polylines.index')}}" class="btn btn-danger">Batal</a>
                    </div>
                </div>
            </div>
        </div>
